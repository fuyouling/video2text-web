# video2text-web 官网建设方案

> 创建日期：2026-08-11
> 作者：Kilo
> 状态：草案（已确认关键决策，待评审）
> 说明：本方案已拆分为模块文件，详见 **[plans/00-overview.md](./00-overview.md)**（总览索引）。

## 模块文件（位于 `plans/`）

| 编号 | 文件                                                     | 主题                                              |
| ---- | -------------------------------------------------------- | ------------------------------------------------- |
| 00   | [00-overview.md](./00-overview.md)                       | 总览索引：背景、目标、已确认关键决策              |
